...
CODES: dict[str, str] = {
    ...
    "WCM-L2-0018": "GPU confidential-compute mode is off, or not established by a verified GPU report, while required",
    "WCM-L2-0019": "the manifest requires cryptographic evidence verification and the KBS has no verifier for it",
    # L3, runtime custody
...
_GATE_CODES: tuple[tuple[str, tuple[str, ...], str], ...] = (
    ...
    ("cpu_quote_verified", ("required by the manifest",), "WCM-L2-0019"),
    ("cpu_quote_verified", ("nonce",), "WCM-L2-0012"),
    ("cpu_quote_verified", (), "WCM-L2-0011"),
    ("gpu_report_verified", ("required by the manifest",), "WCM-L2-0019"),
